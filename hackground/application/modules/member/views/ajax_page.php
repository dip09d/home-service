...
<div class="modal-body">
  <form role="form" id="add_form" action="<?php echo $form_action;?>" onsubmit="submitForm(this, event)">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control reset_field" id="member_phone" name="member_phone" autocomplete="off" value="<?php echo !empty($detail['member_phone']) ? $detail['member_phone'] : ''; ?>">
    </div>
