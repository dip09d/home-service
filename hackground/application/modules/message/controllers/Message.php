...
class Message extends MX_Controller {
   ...
   private $data;
	...
	public function show_conversion($conversation_id = null)
	{
		$this->load->model('message');
		// $this->data['conversation_details'] = $this->message->getConversationDetails($conversation_id);
		$this->data['conversation_details'] = $this->message->getConversationMessages($conversation_id);
		// echo "<pre>"; print_r($this->data['conversation_details']); die;
		$this->data['main_title']   = "View Conversations ";
		// $this->data['second_title']        = "Conversations details";
		$breadcrumb = array(
			array(
				'name' => 'Message',
				'path' => base_url($this->data['curr_controller'].'list_record'),
