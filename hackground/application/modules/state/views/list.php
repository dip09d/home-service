      ...
      <div class="box">
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				$status = '';
				if($v['state_status'] == ACTIVE_STATUS){
				...
				}else if($v['state_status'] == INACTIVE_STATUS){
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:20px;">
					<?php if($v['state_status'] != DELETE_STATUS){ ?>
				<!-- 	<a href="<?php echo JS_VOID; ?>" onclick="add_city('<?php echo $v[$primary_key]; ?>')" data-toggle="tooltip" title="Add City"><i class="fa fa-plus <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
					<a href="<?php echo base_url('city/list_record?state='.$v[$primary_key]); ?>" data-toggle="tooltip" title="City List"><i class="fa fa-list blue <?php echo ICON_SIZE;?>"></i></a>
					&nbsp; -->
...
function add_city(id){
	var url = '<?php echo base_url('city/load_ajax_page?page='.$add_command);?>&state_id='+id;
	load_ajax_modal(url);
}
