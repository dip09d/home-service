...
<div class="modal-body">
  <form role="form" id="add_form" action="<?php echo $form_action;?>" onsubmit="submitForm(this, event)">
    <div class="form-group">
      ...
      <input type="text" class="form-control reset_field" id="name" name="agency_name" autocomplete="off">
    </div>
    <div class="form-group">
      <div>
...
<div class="modal-body">
  <form role="form" id="add_form" action="<?php echo $form_action;?>" onsubmit="submitForm(this, event)">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control reset_field" id="name" name="agency_name" autocomplete="off" value="<?php echo !empty($detail['agency_name']) ? $detail['agency_name'] : ''; ?>">
    </div>
    <div class="form-group">
      <label for="agency_email" class="form-label">Email </label>
      <input type="email" class="form-control reset_field" id="agency_email" name="agency_email" autocomplete="off" value="<?php echo !empty($detail['agency_email']) ? $detail['agency_email'] : ''; ?>">
    </div>
    <div class="form-group">
      <label for="agency_phone" class="form-label">Phone </label>
      <input type="text" class="form-control reset_field" id="agency_phone" name="agency_phone" autocomplete="off" value="<?php echo !empty($detail['agency_phone']) ? $detail['agency_phone'] : ''; ?>">
    </div>
