      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
			<a href="<?php echo base_url('agency/export_csv?export=1'. http_build_query(array_merge($_GET, ['export' => 1])))?>"
		...
		<div class="card-body table-responsive p-0" id="main_table">
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <td> <?php echo $v['agency_member_name']; ?></td>
                  
                 
                  <td><?php echo $v['agency_phone']; ?></td>
                 
                  <td><?php echo date('d M, Y h:i A', strtotime($v['agency_register_date'])); ?></td>
                  ...
                  <td class="text-right" style="padding-right:15px;">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url('agency/view_edit/basic_info/'.$v[$primary_key]); ?>">Edit Full Details</a>
					...
					<?php /*
					&nbsp;
					<a href="<?php echo base_url('proposal/list_record?agency_id='.$v[$primary_key]); ?>" data-toggle="tooltip" title="View Projects"><i class="fa fa-list-alt <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
					<a href="<?php echo base_url('agency/view_edit/basic_info/'.$v[$primary_key]); ?>" data-toggle="tooltip" title="Full Detail"><i class="fa fa-user-secret <?php echo ICON_SIZE;?> red"></i></a>*/?>
				  </td>
