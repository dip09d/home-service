        ...
        <div class="card-header border-0 d-sm-flex align-items-center">
          ...
          <div class="ml-auto">
		   ...
		   <?php if(!get('show')){ ?>
			...
			<?php } ?>
			<a href="<?php echo base_url('email_template/export_csv?export=1')?>"
		...
		<div class="card-body table-responsive p-0" id="main_table">
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <td><?php echo $v['template_for']; ?></td>
                  <td><?php echo $v['template_type']; ?></td>
                  <td><?php echo $status; ?></td>
                  <td align="right">
					<?php if($v['status'] != DELETE_STATUS){ ?>
					<a href="<?php echo JS_VOID; ?>" onclick="edit('<?php echo $v[$primary_key]; ?>')" data-toggle="tooltip" title="Edit"><i class="icon-feather-edit <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
