...
abstract class MX_REST extends MX_Controller{
    ...
    function __construct($config = 'rest'){
        ...
        $this->load->language('rest_controller');
        ...
        $this->_args = array_merge(
            is_array($this->_get_args) ? $this->_get_args : [],
            is_array($this->_query_args) ? $this->_query_args : [],
            is_array($this->_put_args) ? $this->_put_args : [],
            is_array($this->_post_args) ? $this->_post_args : [],
            is_array($this->_delete_args) ? $this->_delete_args : [],
            is_array($this->{'_' . $this->request->method . '_args'}) ? $this->{'_' . $this->request->method . '_args'} : []
        );
